...
suspend fun Client.searchRecipe(search: RecipeSearchFilter): List<RecipeResponseObject> = searchRecipe(search) {
    it should haveSuccessResult
    it.recipes ?: listOf()
}

suspend fun <T> Client.searchRecipe(search: RecipeSearchFilter, block: (RecipeSearchResponse) -> T): T =
