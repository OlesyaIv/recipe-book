...
import olesyaiv.recipebook.app.spring.controllers.RecipeControllerV2Fine
...
@WebFluxTest(
    RecipeControllerV2Fine::class, RecipeBookConfig::class,
    properties = ["spring.main.allow-bean-definition-overriding=true"]
)
@Import(RepoInMemoryConfig::class)
internal class RecipeRepoInMemoryV2Test : RecipeRepoBaseV2Test() {
    @Autowired
